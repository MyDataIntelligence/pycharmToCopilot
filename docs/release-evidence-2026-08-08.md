...
- Command: `.\gradlew.bat test ktlintCheck buildPlugin verifyPlugin -PccbBuildDir=build-final-release22 --no-daemon --console=plain`.
- Result: `BUILD SUCCESSFUL`; 220 tests, 0 failures, 0 errors and 0 skipped tests.
- The release22 gate passed all 220 tests, including external restore, runtime resolver handlers, non-Python whole-file patch operations, relation identity, prompt ordering/import migration, previous-batch filtering, the Chosen/Pinned context-files view, responsive Batch layout, ignored-tree guideline discovery and policy duplication.
...
- Current release22 ZIP produced by `buildPlugin`: 847609 bytes, SHA-256 `8C351BA5DD736F2784F38150E006D0E131E228507A63929125D237979B314ED4`.
- Final verification ZIP: `build-final-release22/distributions/copilot-context-bridge-1.0.0.zip`.
- Final verification size: 847609 bytes.
- Final verification SHA-256: `8C351BA5DD736F2784F38150E006D0E131E228507A63929125D237979B314ED4`.
...
- `install.ps1 -BuildOnly` was run successfully after release22; it produced a fresh ZIP and copied it to `build/distributions`.
...
- A full `install.ps1` run after release22 completed successfully after closing the controlled test instance and atomically installed `%APPDATA%/JetBrains/PyCharm2026.2/plugins/copilot-context-bridge`.
